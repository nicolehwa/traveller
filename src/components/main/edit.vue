...
export default {
    ...
    methods: {
        loadData: function() {
          ...
          http.get(`api/v1.0/tour/${this.$route.params.id}`, (response) => {
              this.manager = response.data.manager;
              this.description = response.data.description;
              this.mode = response.data.mode;
              this.ticket = response.data.ticket;
              this.localCab = response.data.localCab;
              this.destCab = response.data.destCab;
              this.hotel = response.data.hotel;
              this.conveyance = response.data.conveyance;
              this.manager = response.data.manager;
      ...
      draft() {
        http.put(`api/v1.0/tour/${this.$route.params.id}`, {
